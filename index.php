	     ...
	     <ul class="rslides" id="slider">
	         <li>
				 <div class="banner1">				  
					  ...
					  <h3>Offer In StarBazar Banagalore.</h3>
	         ...
	         <li>
				 <div class="banner2">
					 <div class="banner-info">
					 <h3>Offer In Hypercity Banagalore.</h3>
					 <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. consectetur adipiscing elit. consectetur adipiscing elit.</p>
					 </div>
				 </div>
			 </li>
	         <li>
	             <div class="banner3">
	        	 <div class="banner-info">
	        	 <h3>Offer In All Season Super Market Banagalore.</h3>
	          	 <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. consectetur adipiscing elit. consectetur adipiscing elit.</p>
				 </div>
				 </div>
	         </li>
...
<div class="copywrite">
	 <div class="container">
		 <div class="copy">
			 <p>© 2015 Offer Dekho. All Rights Reserved | Design by  <a href="https://www.facebook.com/Mukesh525" target="_blank">Mukesh Jha</a> </p>
		 </div>
		 <div class="social">							
